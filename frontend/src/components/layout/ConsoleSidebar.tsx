...
import { LayoutDashboard, User, Route, FolderOpen, MessageCircle, Settings, Sparkles, Bot, GraduationCap, History, Edit3, Users } from 'lucide-react';
...
export default function ConsoleSidebar() {
  ...
  const roleLabel = isTeacher ? (user?.role === 'admin' ? '管理员' : '教师') : '学习平台用户';
