...
export function groupTasksByDay(stages: unknown): { stageId: string; stageTitle: string; stageIdx: number; days: { dayIndex: number; globalDayIndex: number; tasks: any[]; stageIdx: number }[] }[];
